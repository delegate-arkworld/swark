...
{
    // TODO: fix logo for plugin

    // TODO: check qr-code integration in plugin

    // TODO: remove manual set of $version = 'Two' in ARK Client and check it again

    // TODO: write tests with SwagPaymentPayPalUnified as template
    ...
    {
        // TODO: add additional option to show ark price
        // TODO: Also needs some frontend changes for display of arktoshis

        // TODO: save id of new currency and implement it in the config

        $currency = new \Shopware\Models\Shop\Currency();
        ...
        // TODO: add function to remove currency on uninstall
    }
    ...
    protected function getCurrencyFactor(): float
    {
        $exchangeService = new \Swark\Components\Services\ExchangeService(
            ...
            $this->container->get('swark.components.services.logger_service'),
            $this->container->get('models')
        );

        // TODO: get default currency and set factor on it. Also check if default is used for calculations!!!
        return $exchangeService->getExchangeRate('EUR');
    }
}
